...
public class PenSlot : MonoBehaviour {
    //Effectively a straight copy of Slot right now
    public int index = 0;
    ...
    public void SetItem(ItemInstance instance) {
        ...
        this.prefabInstance = Instantiate(instance.item.physicalRepresentation, transform.position, transform.rotation, this.transform);
    }
